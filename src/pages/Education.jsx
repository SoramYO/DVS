...
const Education = () => {
  ...
  useEffect(() => {
    educationContainerRef.current.scrollTo(0, 0);
  }, []);
  return (
    <div ref={educationContainerRef} className="educationContainer">
      ...
      <div className="image-container">
        <img src="/assets/edu.png" alt="Diamond" />
      </div>
      <div className="verticalFrames">
        <div className="frame">
          ...
          <ul>
            ...
            <li>It’s more critical that your diamond is well-cut.</li>
          </ul>
        </div>
        <div className="frame">
          ...
          <ul>
            ...
            <li><a href="https://www.diamonds.pro/education/color/" target="_blank" rel="noopener noreferrer">Diamond color</a> ranges from D to Z, but there is no need to overpay for a D color diamond.</li>
            <li>An H or I color diamond, depending on the setting, will look just as clear and white as a colorless grade diamond.</li>
          </ul>
        </div>
        <div className="frame">
          ...
          <ul>
            ...
            <li>Above all, opt for a diamond that's eye-clean, meaning you can't see imperfections unless you put it under magnification.</li>
            <li>In our <a href="https://www.diamonds.pro/education/eye-clean-diamonds/" target="_blank" rel="noopener noreferrer">eye-clean diamond article</a> we show you which inclusions, not grades, to look out for.</li>
          </ul>
        </div>
        <div className="frame">
      ...
      <ul>
        <li><strong>Cut</strong>: Determines how well the diamond reflects light.</li>
        <li><strong>Color</strong>: Measures the absence of color; less color equals higher value.</li>
        <li><strong>Clarity</strong>: Indicates the presence of imperfections; fewer flaws mean higher quality.</li>
        <li><strong>Carat</strong>: Refers to the diamond's size.</li>
      </ul>
      <p>
      ...
      <p><em>
        Here is a video where a professional jeweler walks you through the essential factors to consider, including the 4 Cs of diamonds—Carat, Cut, Color, and Clarity. Learn how these elements influence a diamond's beauty and value, and get expert tips: <a href="https://youtu.be/-PifALO8p1Y" target="_blank" rel="noopener noreferrer">https://youtu.be/-PifALO8p1Y</a>
      </em></p>
      <p>
      ...
      <p>
        Without these standards, determining diamond quality would be difficult, allowing dishonest vendors to overcharge.
      </p>
      <p>
