  ...
  return (
    <div className="request-detail-container">
      ...
      <Row gutter={16}>
        <Col span={8}>
          ...
          >
            ...
            <p className="info-text">
              ...
              {new Date(request.updatedDate).toLocaleDateString("en-GB")}
            </p>
            <p className="info-text">
          ...
          >
            ...
            <p>
              <Text strong>Họ:</Text> {request.firstName}
            </p>
            <p>
              <Text strong>Tên:</Text> {request.lastName}
            </p>
            <p>
        ...
        <Col span={8}>
          <Card
            title="Thông tin kim cương"
            bordered={false}
            className="info-card"
          >
            <p>
              <Text strong>Trọng lượng Carat:</Text> {request.caratWeight}
            </p>
            <p>
              <Text strong>Độ trong:</Text> {request.clarity}
            </p>
            <p>
              <Text strong>Màu sắc:</Text> {request.color}
            </p>
            <p>
              <Text strong>Giác cắt:</Text> {request.cut}
            </p>
            <p>
              <Text strong>Xuất xứ kim cương:</Text> {request.diamondOrigin}
            </p>
            <p>
              <Text strong>Huỳnh quang:</Text> {request.fluorescence}
            </p>
            <p>
              <Text strong>Kích thước:</Text> {request.measurements}
            </p>
            <p>
              <Text strong>Đánh bóng:</Text> {request.polish}
            </p>
            <p>
              <Text strong>Tỷ lệ:</Text> {request.proportions}
            </p>
            <p>
              <Text strong>Hình dạng:</Text> {request.shape}
            </p>
            <p>
              <Text strong>Độ đối xứng:</Text> {request.symmetry}
            </p>
          </Card>
        </Col>
